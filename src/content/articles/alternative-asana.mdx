...
<ComparisonTable
  headers={["Critère", "Monday.com", "ClickUp", "Notion", "Trello", "Linear"]}
  rows={[
...
<ComparisonTable
  headers={["Critère", "Asana Starter", "Monday Standard", "ClickUp Business", "Notion Plus", "Trello Standard", "Linear Standard"]}
  rows={[
