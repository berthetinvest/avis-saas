...
<ComparisonTable
  tools={[
    { name: "Notion", plan: "Plus", pricePerMonth: "10 €", features: { docs: true, kanban: true, gantt: false, automation: "limité", support: "Email" } },
    { name: "Asana", plan: "Starter", pricePerMonth: "13,49 €", features: { docs: false, kanban: true, gantt: true, automation: "Rules", support: "Chat" } },
    { name: "Monday.com", plan: "Standard", pricePerMonth: "12 €", features: { docs: false, kanban: true, gantt: true, automation: "250/mois", support: "24/7" } },
    { name: "Linear", plan: "Standard", pricePerMonth: "8 $", features: { docs: true, kanban: true, gantt: "Cycles", automation: "Limité", support: "Community" } },
    { name: "Height", plan: "Team", pricePerMonth: "8,50 $", features: { docs: true, kanban: true, gantt: false, automation: "AI native", support: "Chat" } }
  ]}
...
<ComparisonTable
  tools={[
    { name: "Notion", plan: "Plus", pricePerMonth: "10 €", features: { docs: "Best-in-class", kanban: true, budget: false, dev: false, design: "5/5" } },
    { name: "Asana", plan: "Starter", pricePerMonth: "13,49 €", features: { docs: false, kanban: true, budget: "Starter+", dev: false, design: "4/5" } },
    { name: "Monday", plan: "Standard", pricePerMonth: "12 €", features: { docs: "Basique", kanban: true, budget: "Natif", dev: false, design: "5/5" } },
    { name: "Linear", plan: "Standard", pricePerMonth: "8 $", features: { docs: "Correct", kanban: true, budget: false, dev: "5/5", design: "5/5" } },
    { name: "Height", plan: "Team", pricePerMonth: "8,50 $", features: { docs: "Correct", kanban: true, budget: false, dev: "4/5", design: "4/5" } }
  ]}
